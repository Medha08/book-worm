...
const OrderScreen = ({ match }) => {
  ...
  const onSucessPaymentHandler = (paymentResult) => {
    console.log(paymentResult, order);
    dispatch(payOrderDetails(orderId, paymentResult));
  };
                ...
                <ListGroup.Item>
                  ...
                  {!sdkReady ? (
                    ...
                    <PayPalButton
                      ...
                      onSuccess={onSucessPaymentHandler}
                    ></PayPalButton>
                  )}
                </ListGroup.Item>
              )}
